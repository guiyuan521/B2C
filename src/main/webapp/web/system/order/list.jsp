	...
	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 0px; padding: 5px">
		...
		<form class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="name" placeholder="请输入用户编号" autocomplete="off" class="layui-input">
				</div>
		...
		<table class="layui-table">
			...
			<thead>
				<tr>
					<th>序号</th><th>订单编号</th>
					<th>用户编号</th><th>时间</th>
					<th>收获地址ID</th><th>状态</th><th>操作</th>
				</tr>
			</thead>
...
formSubmit('/order/selectModel.do','submit(order_search)','json',function(data) {
...
function openOrderUpd(code){
	openLayer('/web/system/order/upd.jsp?code='+code,refresh)
}
function openSpInfo(code){
	openLayer('/web/system/order/spinfo.jsp?code='+code,refresh)
}
